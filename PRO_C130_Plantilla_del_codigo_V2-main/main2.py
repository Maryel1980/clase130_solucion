...
#Leer archivo csv.
final_planets_df = pd.read_csv("final.csv")
...
final_planets_df.drop(columns=['hyperlink',  'temp_planet_date',
...
final_planets_df = final_planets_df.rename({
...
final_planets_df.head(50)

#Guardar en el archivo csv.
final_planets_df.to_csv('main.csv')
